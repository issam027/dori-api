...
export declare class ServiceTiersController {
    private readonly serviceTiersService;
    constructor(serviceTiersService: ServiceTiersService);
    ...
    getDisplay(user: UserContext, queueId: number): Promise<{
        queueId: number;
        queueCode: string;
